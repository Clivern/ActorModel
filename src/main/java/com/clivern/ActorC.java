...
public class ActorC extends AbstractBehavior<ActorC.Payload> {
    ...
    public static Behavior<Payload> create(Injector injector) {
        return Behaviors.setup(context -> new ActorC(context, injector));
    }

    private ActorC(ActorContext<Payload> context, Injector injector) {
        super(context);
    ...
    private Behavior<Payload> onMessage(Payload payload) throws Exception {
